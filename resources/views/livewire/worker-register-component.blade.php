<div class="col-md-10 d-flex mt-md-0 mx-auto p-0">
    <div class="card flex-grow-1 my-0 transition-fade" id="swup">
        <div class="card-body p-0">
            ...
            <form wire:submit.prevent='SaveWorker' enctype="multipart/form-data">
                @csrf
                <div class="col-lg-12 employee-data">
                                ...
                                <div class="col-11 mx-auto">
                                    <div class="row">
                                        <div class="form-group mb-4 col-lg-5 col-sm-12">
                                            ...
                                            <input class="form-control form-control-lg @error('firstName') is-invalid @enderror" name="firstName"
                                                placeholder="First name" type="text" wire:model="firstName" value="{{old('firstName')}}">
                                        ...
                                        <div class=" form-group mb-4 col-lg-4 col-sm-12 ">
                                            <label for="Middlename">{{ __('Middle Name')}}
                                            </label>
                                            <input class="form-control form-control-lg @error('Lastname') is-invalid @enderror" name="Lastname" placeholder="Last Name" type="text" wire:model="Lastname" value="{{__('Lastname')}}">
                                        ...
                                        <div class=" form-group mb-4 col-lg-3 col-sm-12 ">
                                            ...
                                            <input class="form-control form-control-lg @error('Othername') is-invalid @enderror" name="Othername"
                                                placeholder="Other name" wire:model="Othername" value="{{ old('Othername') }}" type="text">
                                    ...
                                    <div class=" row">
                                        <div class="form-group mb-4 col-lg-5 col-sm-12 ">
                                            ...
                                            <input class="form-control @error('MobileN01') is-invalid @enderror"
                                                ...
                                                value="{{ old('MobileN01') }}"  wire:model="MobileN01" />
                                        ...
                                        <div class="form-group mb-4 col-lg-4 col-sm-12 ">
                                            ...
                                            <input class="form-control @error('MobileN02') is-invalid @enderror" inputmode="numeric" maxlength="11" minlength="11" name="MobileN02" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57" pattern="[0-9]*" placeholder="Seconday Mobile N0" tabindex="3" type="text"
                                                value="{{ old('MobileN02') }}"  wire:model="MobileN02" />
                                        ...
                                        <div class="form-group mb-4 col-lg-3 col-sm-12 ">
                                            ...
                                            <input class="form-control @error('MobileN03') is-invalid @enderror"
                                                ...
                                                type="text" value="{{ old('MobileN03') }}" wire:model="MobileN03" />
                                    ...
                                    <div class="row d-flex">
                                        <div class="form-group mb-4 col-lg-8 col-sm-12 flex-md-shrink-0">
                                            ...
                                            <input class="form-control form-control-lg @error('email') is-invalid @enderror" id="signup-email" placeholder="{{__('enter valid email address')}}" type="email" name="email" wire:model="email">
                            ...
                            <div class="col-11 mx-auto">
                                <div class="row">
                                    <div class="form-group col-lg-6 col-sm-12 ">
                                        ...
                                        <input class="form-control" name="IdCard" type="file" value="{{ old('IdCard') }}" wire:model="IdCard">
                                    ...
                                    <div class="form-group col-lg-6 col-sm-12 ">
                                        ...
                                        <input class="form-control" name="profilePhoto" type="file" value="{{ old('profilePhoto') }}"
                                            wire:model="profilePhoto" accept="image/*" />
                                        <span class="invalid-feedback">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6 mx-auto col-sm-12 ">
                                        ...
                                        <input class="form-control form-control-lg" name="confirm_password" placeholder="confirm password"
                                            type="password" value="{{ old('confirm_password')}}" wire:model="confirm_password">
                    ...
                    <div class="col-lg-8 col-sm-12 mx-auto">
                        <div class="row">
                            ...
                            <div class="col-lg-6 mx-auto">
                                <div class="form-group mb-0 mr-auto float-right">
                                    <button type="button" wire:click.prevent='PreviousBtnt'
                                        class="btn btn-outline-primary btn-radius mb-4 continue"><span>Back</span> <i
                        ...
                        <div class="col-lg-6 mx-auto">
                            <div class="form-group mb-0 mr-auto float-right">
                                <button type="button" wire:click.prevent='ContinueNext'
                                    class="btn btn-outline-primary btn-radius mb-4 continue step1-form"> <span>Continue</span>
                        ...
                        <div class="col-lg-6 mx-auto">
                            <div class="form-group mb-0 mr-auto float-right">
                                <button type="submit"   class="btn btn-outline-primary btn-radius mb-4 continue final">Register
                                    <i class="fas fa-angle-double-right ml-2"></i></button>
                            </div>
                        </div>
                        @endif
