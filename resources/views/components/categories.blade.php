                            ...
                            <div class="category-card__image image image--type--category">
                                <a href="" class="image__body">
                                    <img class="image__tag"
                                        src="{{ asset('frontend/images/categories/category-1-160x160.jpg') }}" alt="">
                                </a>
                            </div>
                    ...
                    <div class="category-card__body">
                        <div class="category-card__content">
                            <div class="category-card__image image image--type--category">
                                <a href="" class="image__body">
                                    <img class="image__tag"
                                        src="{{ asset('frontend/images/categories/category-2-160x160.jpg') }}" alt="">
                                </a>
                            </div>
                            <div class="category-card__info">
                                <div class="category-card__name">
                    ...
                    <div class="category-card__body">
                        <div class="category-card__content">
                            <div class="category-card__image image image--type--category">
                                <a href="" class="image__body">
                                    <img class="image__tag"
                                        src="{{ asset('frontend/images/categories/category-3-160x160.jpg') }}" alt="">
                                </a>
                            </div>
                            <div class="category-card__info">
                                <div class="category-card__name">
                    ...
                    <div class="category-card__body">
                        <div class="category-card__content">
                            <div class="category-card__image image image--type--category">
                                <a href="" class="image__body">
                                    <img class="image__tag"
                                        src="{{ asset('frontend/images/categories/category-4-160x160.jpg') }}" alt="">
                                </a>
                            </div>
                            <div class="category-card__info">
                                <div class="category-card__name">
                    ...
                    <div class="category-card__body">
                        <div class="category-card__content">
                            <div class="category-card__image image image--type--category">
                                <a href="" class="image__body">
                                    <img class="image__tag"
                                        src="{{ asset('frontend/images/categories/category-5-160x160.jpg') }}" alt="">
                                </a>
                            </div>
                            <div class="category-card__info">
                                <div class="category-card__name">
                    ...
                    <div class="category-card__body">
                        <div class="category-card__content">
                            <div class="category-card__image image image--type--category">
                                <a href="" class="image__body">
                                    <img class="image__tag"
                                        src="{{ asset('frontend/images/categories/category-6-160x160.jpg') }}" alt="">
                                </a>
                            </div>
                            <div class="category-card__info">
                                <div class="category-card__name">
