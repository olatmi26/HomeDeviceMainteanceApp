            ...
            <div class="mobile-menu__panel-body">
                        ...
                        <div class="mobile-menu__setting-panel" data-mobile-menu-panel>
                            <div class="mobile-menu__panel mobile-menu__panel--hidden">
                                <div class="mobile-menu__panel-header">
                                    ...
                                    <div class="mobile-menu__panel-title">Select Preferred Currency</div>
                                </div>
                                <div class="mobile-menu__panel-body">
                ...
                <div class="mobile-menu__indicators">
                    ...
                    <a class="mobile-menu__indicator" href="account-garage.html">
                       ...
                       <span class="mobile-menu__indicator-title">Track Order</span>
                    </a>
                ...
                <ul class="mobile-menu__links">
                                                ...
                                                <div class="mobile-menu__panel mobile-menu__panel--hidden">
                                                    ...
                                                    <div class="mobile-menu__panel-body">
                                                        <ul class="mobile-menu__links">
                                                            ...
                                                            <li data-mobile-menu-item>
                                                                <a href="header-spaceship-variant-three.html" class=""
                                                                    data-mobile-menu-trigger>
                                                                    Variant Three
                                                                </a>
                                                            </li>
                        ...
                        <div class="mobile-menu__links-panel" data-mobile-menu-panel>
                            <div class="mobile-menu__panel mobile-menu__panel--hidden">
                                <div class="mobile-menu__panel-header">
                                    ...
                                    <div class="mobile-menu__panel-title">Car Spare parts</div>
                                </div>
                                <div class="mobile-menu__panel-body">
                                    <ul class="mobile-menu__links">
                                        <li data-mobile-menu-item>
                    ...
                    <li data-mobile-menu-item>
                        <a href="#workers" class="" data-mobile-menu-trigger>
                            Workers
                            <svg width="7" height="11">
                                <path
                                    d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9  C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                        ...
                        <div class="mobile-menu__links-panel" data-mobile-menu-panel>
                            <div class="mobile-menu__panel mobile-menu__panel--hidden">
                                <div class="mobile-menu__panel-header">
                                    ...
                                    <div class="mobile-menu__panel-title">Back-Office</div>
                                </div>
                                <div class="mobile-menu__panel-body">
                                    <ul class="mobile-menu__links">
                                        @guest('worker')
                                            ...
                                            <li data-mobile-menu-item>
                                                <a href="{{ route('worker.register') }}" class="" data-mobile-menu-trigger>
                                                    Register
                                                </a>
                                            </li>
                                        @endguest
                        ...
                        <div class="mobile-menu__links-panel" data-mobile-menu-panel>
                            <div class="mobile-menu__panel mobile-menu__panel--hidden">
                                <div class="mobile-menu__panel-header">
                                    ...
                                    <div class="mobile-menu__panel-title">Our Services</div>
                                </div>
                                <div class="mobile-menu__panel-body">
                                    <ul class="mobile-menu__links">
                                        <li data-mobile-menu-item>
                ...
                <a class="mobile-menu__contacts" href="">
                    ...
                    <div class="mobile-menu__contacts-title">(02)+36128076</div>
                </a>
            </div>
        </div>
    </div>
