...
<head>
    ...
    <meta name="format-detection" content="telephone=no">
     <title> {{ __(' ProcodeMS System') }}@yield('title')</title>
...
<meta name="theme-color" content="#ffffff">
    ...
    <link rel="stylesheet" href="{{asset('frontend/css/style.header-classic-variant-one.css')}}"
        media="(min-width: 1200px)">
    <link rel="stylesheet" href="{{asset('frontend/css/style.mobile-header-variant-one.css')}}"
...
<body>
                    ...
                    <div class="mobile-header__body">
                        ...
                        <div class="mobile-header__search mobile-search">
                            <form class="mobile-search__body">
                                <input type="text" class="mobile-search__input"
                ...
                <div class="header__topbar-classic">
                    <div class="topbar topbar--classic">
                        ...
                        <div class="topbar__item-text"><a class="topbar__link"
                                href="blog-classic-right-sidebar.html">Blog</a></div>
                        ...
                        <div class="topbar__menu">
                            ...
                            <div class="topbar__menu-body">
                                <a class="topbar__menu-item" href="#">
                                    <img src="{{ asset('frontend/images/languages/language-1.png') }}"
                                        alt=""><span>English</span>
                                </a>
                                <a class="topbar__menu-item" href="#">
                                    <img src="{{ asset('frontend/images/languages/language-2.png') }}"
                                        alt=""><span>French</span>
                                </a>
                                <a class="topbar__menu-item" href="#">
                                    <img src="{{ asset('frontend/images/languages/language-3.png') }}"
                                        alt=""><span>German</span>
                                </a>
                                <a class="topbar__menu-item" href="#">
                                    <img src="{{ asset('frontend/images/languages/language-4.png') }}"
                                        alt=""><span>Russian</span>
                                </a>
                                <a class="topbar__menu-item" href="#">
                                    <img src="{{ asset('frontend/images/languages/language-5.png') }}"
                                        alt=""><span>Italian</span>
                                </a>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="departments__item-menu">
                                                <div
                                                    ...
                                                    <div class="megamenu__image">
                                                        <img src="{{ asset('frontend/images/departments/departments-2.jpg') }}"
                                                            alt="">
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-1of5">
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                                            ...
                                            <div class="departments__item-menu">
                                                <div
                                                    ...
                                                    <div class="megamenu__image">
                                                        <img src="{{ asset('frontend/images/departments/departments-1.jpg') }}"
                                                            alt="">
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-3">
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                                            ...
                                            <div class="departments__item-menu">
                                                <div
                                                    ...
                                                    <div class="megamenu__image">
                                                        <img src="{{ asset('frontend/images/departments/departments-3.jpg') }}"
                                                            alt="">
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-4">
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                                            ...
                                            <div class="departments__item-menu">
                                                <div
                                                    ...
                                                    <div class="megamenu__image">
                                                        <img src="{{ asset('frontend/images/departments/departments-4.jpg') }}"
                                                            alt="">
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-6">
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                        ...
                        <div class="main-menu">
                            <ul class="main-menu__list">
                                ...
                                <li class="main-menu__item">
                                    <a href="https://themeforest.net/item/redparts-auto-parts-html-template/24735474"
                                        class="main-menu__link" target="_blank">
                                        Buy Theme
                                    </a>
                                </li>
                            </ul>
                ...
                <div class="header__logo">
                    ...
                    {{-- can u see it clearly nowyes--}} I wan to unboundle this larger files to modules b4 morning.
                </div>
                                    ...
                                    <div class="vehicle-picker__panel-body">
                                        ...
                                        <div class="vehicle-picker__actions">
                                            <button type="button" class="btn btn-primary btn-sm"
                                                data-to-panel="form">Add A Vehicle</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="vehicle-picker__panel vehicle-picker__panel--form" data-panel="form">
                                    <div class="vehicle-picker__panel-body">
                                        <div class="vehicle-form vehicle-form--layout--search">
                                            ...
                                            <div class="vehicle-form__item vehicle-form__item--select">
                                                <select class="form-control form-control-select2" aria-label="Brand"
                                                    disabled>
                                            ...
                                            <div class="vehicle-form__item vehicle-form__item--select">
                                                <select class="form-control form-control-select2" aria-label="Model"
                                                    disabled>
                                    ...
                                    <li class="dropcart__item">
                                        <div class="dropcart__item-image image image--type--product">
                                            <a class="image__body" href="product-full.html">
                                                <img class="image__tag"
                                                    src="{{ asset('frontend/images/products/product-4-70x70.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
	...
	C9.2,7.8,9.2,8.4,8.8,8.8z" />
                                    ...
                                    <li class="dropcart__item">
                                        <div class="dropcart__item-image image image--type--product">
                                            <a class="image__body" href="product-full.html">
                                                <img class="image__tag"
                                                    src="{{ asset('frontend/images/products/product-2-70x70.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="dropcart__item-info">
	...
	C9.2,7.8,9.2,8.4,8.8,8.8z" />
                                    ...
                                    <li class="dropcart__item">
                                        <div class="dropcart__item-image image image--type--product">
                                            <a class="image__body" href="product-full.html">
                                                <img class="image__tag"
                                                    src="{{ asset('frontend/images/products/product-5-70x70.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="dropcart__item-info">
                        ...
                        <div class="owl-carousel">
                            <a class="block-slideshow__item" href="">
                                <span class="block-slideshow__item-image block-slideshow__item-image--desktop"
                                    style="background-image: url('frontend/images/slides/bg-section-1.jpg')"></span>
                                <span class="block-slideshow__item-image block-slideshow__item-image--mobile"
                                    style="background-image: url('frontend/images/slides/home298-1.jpg')">
                                </span>
                                <span class="block-slideshow__item-offer">
                                    30% OFF
                                </span>
                                <span class="block-slideshow__item-title text-white">
                            ...
                            <a class="block-slideshow__item" href="">
                                <span class="block-slideshow__item-image block-slideshow__item-image--desktop"
                                    style="background-image: url('frontend/images/slides/slider-4.jpg'); background-position:center center"></span>
                                <span class="block-slideshow__item-image block-slideshow__item-image--mobile"
                                    style="background-image: url('{{ asset('frontend/images/slides/slide-2-mobile.jpg') }}"></span>
                                <span class="block-slideshow__item-title text-white">
                                    Not enough<br>
                                    spare parts?
                                </span>
                            ...
                            <a class="block-slideshow__item" href="">
                                <span class="block-slideshow__item-image block-slideshow__item-image--desktop"
                                    style="background-image: url('frontend/images/slides/slide-new1.jpg')"></span>
                                <span class="block-slideshow__item-image block-slideshow__item-image--mobile"
                                    style="background-image: url('{{ asset('frontend/images/slides/slide-1-mobile.jpg') }}"></span>
                                <span class="block-slideshow__item-offer">
                                    30% OFF
                                </span>
                                <span class="block-slideshow__item-title text-white">
                    ...
                    <ul class="block-brands__list">
                        <li class="block-brands__item">
                            <a href="" class="block-brands__item-link">
                                <img src="{{ asset('frontend/images/brands/brand-1.png') }}" alt="">
                        ...
                        <li class="block-brands__item">
                            <a href="" class="block-brands__item-link">
                                <img src="{{ asset('frontend/images/brands/brand-2.png') }}" alt="">
                        ...
                        <li class="block-brands__item">
                            <a href="" class="block-brands__item-link">
                                <img src="{{ asset('frontend/images/brands/brand-3.png') }}" alt="">
                        ...
                        <li class="block-brands__item">
                            <a href="" class="block-brands__item-link">
                                <img src="{{ asset('frontend/images/brands/brand-4.png') }}" alt="">
                        ...
                        <li class="block-brands__item">
                            <a href="" class="block-brands__item-link">
                                <img src="{{ asset('frontend/images/brands/brand-5.png') }}" alt="">
                        ...
                        <li class="block-brands__item">
                            <a href="" class="block-brands__item-link">
                                <img src="{{ asset('frontend/images/brands/brand-6.png') }}" alt="">
                        ...
                        <li class="block-brands__item">
                            <a href="" class="block-brands__item-link">
                                <img src="{{ asset('frontend/images/brands/brand-7.png') }}" alt="">
                        ...
                        <li class="block-brands__item">
                            <a href="" class="block-brands__item-link">
                                <img src="{{ asset('frontend/images/brands/brand-8.png') }}" alt="">
                        ...
                        <li class="block-brands__item">
                            <a href="" class="block-brands__item-link">
                                <img src="{{ asset('frontend/images/brands/brand-9.png') }}" alt="">
                        ...
                        <li class="block-brands__item">
                            <a href="" class="block-brands__item-link">
                                <img src="{{ asset('frontend/images/brands/brand-10.png') }}" alt="">
                        ...
                        <li class="block-brands__item">
                            <a href="" class="block-brands__item-link">
                                <img src="{{ asset('frontend/images/brands/brand-11.png') }}" alt="">
                        ...
                        <li class="block-brands__item">
                            <a href="" class="block-brands__item-link">
                                <img src="{{ asset('frontend/images/brands/brand-12.png') }}" alt="">
                        ...
                        <li class="block-brands__item">
                            <a href="" class="block-brands__item-link">
                                <img src="{{ asset('frontend/images/brands/brand-13.png') }}" alt="">
                        ...
                        <li class="block-brands__item">
                            <a href="" class="block-brands__item-link">
                                <img src="{{ asset('frontend/images/brands/brand-14.png') }}" alt="">
                        ...
                        <li class="block-brands__item">
                            <a href="" class="block-brands__item-link">
                                <img src="{{ asset('frontend/images/brands/brand-15.png') }}" alt="">
                        ...
                        <li class="block-brands__item">
                            <a href="" class="block-brands__item-link">
                                <img src="{{ asset('frontend/images/brands/brand-16.png') }}" alt="">
                                    ...
                                    <div class="category-card__content">
                                        <div class="category-card__image image image--type--category">
                                            <a href="" class="image__body">
                                                <img class="image__tag"
                                                    src="{{ asset('frontend/images/categories/category-1-160x160.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                ...
                                <div class="category-card__body">
                                    <div class="category-card__content">
                                        <div class="category-card__image image image--type--category">
                                            <a href="" class="image__body">
                                                <img class="image__tag"
                                                    src="{{ asset('frontend/images/categories/category-2-160x160.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="category-card__info">
                                ...
                                <div class="category-card__body">
                                    <div class="category-card__content">
                                        <div class="category-card__image image image--type--category">
                                            <a href="" class="image__body">
                                                <img class="image__tag"
                                                    src="{{ asset('frontend/images/categories/category-3-160x160.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="category-card__info">
                                ...
                                <div class="category-card__body">
                                    <div class="category-card__content">
                                        <div class="category-card__image image image--type--category">
                                            <a href="" class="image__body">
                                                <img class="image__tag"
                                                    src="{{ asset('frontend/images/categories/category-4-160x160.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="category-card__info">
                                ...
                                <div class="category-card__body">
                                    <div class="category-card__content">
                                        <div class="category-card__image image image--type--category">
                                            <a href="" class="image__body">
                                                <img class="image__tag"
                                                    src="{{ asset('frontend/images/categories/category-5-160x160.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="category-card__info">
                                ...
                                <div class="category-card__body">
                                    <div class="category-card__content">
                                        <div class="category-card__image image image--type--category">
                                            <a href="" class="image__body">
                                                <img class="image__tag"
                                                    src="{{ asset('frontend/images/categories/category-6-160x160.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="category-card__info">
                                        ...
                                        <div class="product-card__image">
                                            <div class="image image--type--product">
                                                <a href="product-full.html" class="image__body">
                                                    <img class="image__tag"
                                                        src="{{ asset('frontend/images/products/product-1-245x245.jpg') }}"
                                                        alt="">
                                                </a>
                                            </div>
                                            <div
	...
	l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                        ...
                                        <div class="product-card__image">
                                            <div class="image image--type--product">
                                                <a href="product-full.html" class="image__body">
                                                    <img class="image__tag"
                                                        src="{{ asset('frontend/images/products/product-2-245x245.jpg') }}"
                                                        alt="">
                                                </a>
                                            </div>
                                            <div
	...
	l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                        ...
                                        <div class="product-card__image">
                                            <div class="image image--type--product">
                                                <a href="product-full.html" class="image__body">
                                                    <img class="image__tag"
                                                        src="{{ asset('frontend/images/products/product-3-245x245.jpg') }}"
                                                        alt="">
                                                </a>
                                            </div>
                                            <div
	...
	l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                        ...
                                        <div class="product-card__image">
                                            <div class="image image--type--product">
                                                <a href="product-full.html" class="image__body">
                                                    <img class="image__tag"
                                                        src="{{ asset('frontend/images/products/product-4-245x245.jpg') }}"
                                                        alt="">
                                                </a>
                                            </div>
                                            <div
	...
	l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                        ...
                                        <div class="product-card__image">
                                            <div class="image image--type--product">
                                                <a href="product-full.html" class="image__body">
                                                    <img class="image__tag"
                                                        src="{{ asset('frontend/images/products/product-5-245x245.jpg') }}"
                                                        alt="">
                                                </a>
                                            </div>
                                            <div
	...
	l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                        ...
                                        <div class="product-card__image">
                                            <div class="image image--type--product">
                                                <a href="product-full.html" class="image__body">
                                                    <img class="image__tag"
                                                        src="{{ asset('frontend/images/products/product-6-245x245.jpg') }}"
                                                        alt="">
                                                </a>
                                            </div>
                                            <div
	...
	l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                        ...
                                        <div class="product-card__image">
                                            <div class="image image--type--product">
                                                <a href="product-full.html" class="image__body">
                                                    <img class="image__tag"
                                                        src="{{ asset('frontend/images/products/product-7-245x245.jpg') }}"
                                                        alt="">
                                                </a>
                                            </div>
                                            <div
	...
	l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                        ...
                                        <div class="product-card__image">
                                            <div class="image image--type--product">
                                                <a href="product-full.html" class="image__body">
                                                    <img class="image__tag"
                                                        src="{{ asset('frontend/images/products/product-8-245x245.jpg') }}"
                                                        alt="">
                                                </a>
                                            </div>
                                            <div
	...
	l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                        ...
                                        <div class="product-card__image">
                                            <div class="image image--type--product">
                                                <a href="product-full.html" class="image__body">
                                                    <img class="image__tag"
                                                        src="{{ asset('frontend/images/products/product-9-245x245.jpg') }}"
                                                        alt="">
                                                </a>
                                            </div>
                                            <div
	...
	l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                        ...
                                        <div class="product-card__image">
                                            <div class="image image--type--product">
                                                <a href="product-full.html" class="image__body">
                                                    <img class="image__tag"
                                                        src="{{ asset('frontend/images/products/product-10-245x245.jpg') }}"
                                                        alt="">
                                                </a>
                                            </div>
                                            <div
                    ...
                    <div class="block-banners__list">
                        <a href="" class="block-banners__item block-banners__item--style--one">
                            <span class="block-banners__item-image"><img
                                    src="{{ asset('frontend/images/banners/banner1.jpg') }}" alt=""></span>
                        ...
                        <a href="" class="block-banners__item block-banners__item--style--two">
                            <span class="block-banners__item-image"><img
                                    src="{{ asset('frontend/images/banners/banner2.jpg') }}" alt=""></span>
                            <span class="block-banners__item-image block-banners__item-image--blur"><img
                                    src="{{ asset('frontend/images/banners/banner2.jpg') }}" alt=""></span>
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                    ...
                    <div class="block-sale__body">
                        ...
                        <div class="block-sale__image"
                            style="background-image: url('{{ asset('frontend/images/sale-1903x640.jpg') }}"></div>
                        <div class="container">
                        ...
                        <div class="owl-carousel">
                                ...
                                <div class="post-card">
                                    <div class="post-card__image">
                                        <a href="post-full-width.html">
                                            <img src="{{ asset('frontend/images/posts/post-1-730x485.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-card__content">
                                        ...
                                        <div class="post-card__excerpt">
                                            <div class="typography">
                                                ...
                                                nibh facilisis. Vivamus venenatis viverra iaculis. Suspendisse tempor
                                                orci non sapien ullamcorper dapibus.
                                                Suspendisse at velit diam. Donec pharetra nec enim blandit vulputate.
                                            </div>
                                        </div>
                                        <div class="post-card__more">
                                            <a href="post-full-width.html" class="btn btn-secondary btn-sm">Read
                                                more</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="block-posts-carousel__item">
                                <div class="post-card">
                                    <div class="post-card__image">
                                        <a href="post-full-width.html">
                                            <img src="{{ asset('frontend/images/posts/post-2-730x485.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-card__content">
                                        <div class="post-card__category">
                            ...
                            <div class="block-posts-carousel__item">
                                <div class="post-card">
                                    <div class="post-card__image">
                                        <a href="post-full-width.html">
                                            <img src="{{ asset('frontend/images/posts/post-3-730x485.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-card__content">
                                        <div class="post-card__category">
                            ...
                            <div class="block-posts-carousel__item">
                                <div class="post-card">
                                    <div class="post-card__image">
                                        <a href="post-full-width.html">
                                            <img src="{{ asset('frontend/images/posts/post-4-730x485.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-card__content">
                                        <div class="post-card__category">
                                        ...
                                        <div class="post-card__title">
                                            <h2><a href="post-full-width.html">A Variety Of Other Academic And
                                                    Non-Academic Approaches Have Been Explored</a></h2>
                                        </div>
                                        <div class="post-card__date">
                            ...
                            <div class="block-posts-carousel__item">
                                <div class="post-card">
                                    <div class="post-card__image">
                                        <a href="post-full-width.html">
                                            <img src="{{ asset('frontend/images/posts/post-5-730x485.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-card__content">
                                        <div class="post-card__category">
                            ...
                            <div class="block-posts-carousel__item">
                                <div class="post-card">
                                    <div class="post-card__image">
                                        <a href="post-full-width.html">
                                            <img src="{{ asset('frontend/images/posts/post-6-730x485.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-card__content">
                                        <div class="post-card__category">
                        ...
                        <div class="mobile-menu__setting" data-mobile-menu-item>
                            <button class="mobile-menu__setting-button" title="Language" data-mobile-menu-trigger>
                                <span class="mobile-menu__setting-icon">
                                    <img src="{{ asset('frontend/images/languages/language-5.png') }}" alt="">
                                </span>
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                                                    ...
                                                    <div class="mobile-menu__panel mobile-menu__panel--hidden">
                                                        ...
                                                        <div class="mobile-menu__panel-body">
                                                            <ul class="mobile-menu__links">
                                                                ...
                                                                <li data-mobile-menu-item>
                                                                    <a href="header-spaceship-variant-two.html" class=""
                                                                        data-mobile-menu-trigger>
                                                                        Variant Two
                                                                    </a>
                                                                </li>
                                            ...
                                            <li data-mobile-menu-item>
                                                <a href="header-classic-variant-one.html" class=""
                                                    data-mobile-menu-trigger>
                                                    Header Classic
                                                    <svg width="7" height="11">
                                                        <path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                                                    ...
                                                    <div class="mobile-menu__panel mobile-menu__panel--hidden">
                                                        ...
                                                        <div class="mobile-menu__panel-body">
                                                            <ul class="mobile-menu__links">
                                                                ...
                                                                <li data-mobile-menu-item>
                                                                    <a href="header-classic-variant-two.html" class=""
                                                                        data-mobile-menu-trigger>
                                                                        Variant Two
                                                                    </a>
                                                                </li>
                                                                <li data-mobile-menu-item>
                                                                    <a href="header-classic-variant-three.html" class=""
                                                                        data-mobile-menu-trigger>
                                                                        Variant Three
                                                                    </a>
                                                                </li>
                                                                <li data-mobile-menu-item>
                                                                    <a href="header-classic-variant-four.html" class=""
                                                                        data-mobile-menu-trigger>
                                                                        Variant Four
                                                                    </a>
                                                                </li>
                                                                <li data-mobile-menu-item>
                                                                    <a href="header-classic-variant-five.html" class=""
                                                                        data-mobile-menu-trigger>
                                                                        Variant Five
                                                                    </a>
                                                                </li>
                                            ...
                                            <li data-mobile-menu-item>
                                                <a href="mobile-header-variant-one.html" class=""
                                                    data-mobile-menu-trigger>
                                                    Mobile Header
                                                    <svg width="7" height="11">
                                                        <path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
                                                    ...
                                                    <div class="mobile-menu__panel mobile-menu__panel--hidden">
                                                        ...
                                                        <div class="mobile-menu__panel-body">
                                                            <ul class="mobile-menu__links">
                                                                ...
                                                                <li data-mobile-menu-item>
                                                                    <a href="mobile-header-variant-two.html" class=""
                                                                        data-mobile-menu-trigger>
                                                                        Variant Two
                                                                    </a>
                                                                </li>
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                                                ...
                                                <div class="mobile-menu__links-panel" data-mobile-menu-panel>
                                                    <div class="mobile-menu__panel mobile-menu__panel--hidden">
                                                        ...
                                                        <div class="mobile-menu__panel-body">
                                                            <ul class="mobile-menu__links">
                                                                <li data-mobile-menu-item>
                                                                    <a href="category-3-columns-sidebar.html" class=""
                                                                        data-mobile-menu-trigger>
                                                                        3 Columns Sidebar
                                                                    </a>
                                                                </li>
                                                                <li data-mobile-menu-item>
                                                                    <a href="category-4-columns-sidebar.html" class=""
                                                                        data-mobile-menu-trigger>
                                                                        4 Columns Sidebar
                                                                    </a>
                                                                </li>
                                                                <li data-mobile-menu-item>
                                                                    <a href="category-5-columns-sidebar.html" class=""
                                                                        data-mobile-menu-trigger>
                                                                        5 Columns Sidebar
                                                                    </a>
                                                                </li>
                                                                <li data-mobile-menu-item>
                                                                    <a href="category-4-columns-full.html" class=""
                                                                        data-mobile-menu-trigger>
                                                                        4 Columns Full
                                                                    </a>
                                                                </li>
                                                                <li data-mobile-menu-item>
                                                                    <a href="category-5-columns-full.html" class=""
                                                                        data-mobile-menu-trigger>
                                                                        5 Columns Full
                                                                    </a>
                                                                </li>
                                                                <li data-mobile-menu-item>
                                                                    <a href="category-6-columns-full.html" class=""
                                                                        data-mobile-menu-trigger>
                                                                        6 Columns Full
                                                                    </a>
                                                                </li>
                                                                <li data-mobile-menu-item>
                                                                    <a href="category-7-columns-full.html" class=""
                                                                        data-mobile-menu-trigger>
                                                                        7 Columns Full
                                                                    </a>
                                                                </li>
                                                                <li data-mobile-menu-item>
                                                                    <a href="category-right-sidebar.html" class=""
                                                                        data-mobile-menu-trigger>
                                                                        Right Sidebar
                                                                    </a>
                                                                </li>
                                            ...
                                            <li data-mobile-menu-item>
                                                <a href="shop-grid-4-columns-sidebar.html" class=""
                                                    data-mobile-menu-trigger>
                                                    Shop Grid
                                                    <svg width="7" height="11">
                                                        <path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
                                                ...
                                                <div class="mobile-menu__links-panel" data-mobile-menu-panel>
                                                    <div class="mobile-menu__panel mobile-menu__panel--hidden">
                                                        ...
                                                        <div class="mobile-menu__panel-body">
                                                            <ul class="mobile-menu__links">
                                                                <li data-mobile-menu-item>
                                                                    <a href="shop-grid-6-columns-full.html" class=""
                                                                        data-mobile-menu-trigger>
                                                                        6 Columns Full
                                                                    </a>
                                                                </li>
                                                                <li data-mobile-menu-item>
                                                                    <a href="shop-grid-5-columns-full.html" class=""
                                                                        data-mobile-menu-trigger>
                                                                        5 Columns Full
                                                                    </a>
                                                                </li>
                                                                <li data-mobile-menu-item>
                                                                    <a href="shop-grid-4-columns-full.html" class=""
                                                                        data-mobile-menu-trigger>
                                                                        4 Columns Full
                                                                    </a>
                                                                </li>
                                                                ...
                                                                <li data-mobile-menu-item>
                                                                    <a href="shop-grid-3-columns-sidebar.html" class=""
                                                                        data-mobile-menu-trigger>
                                                                        3 Columns Sidebar
                                                                    </a>
                                                                </li>
                            ...
                            <div class="mobile-menu__links-panel" data-mobile-menu-panel>
                                <div class="mobile-menu__panel mobile-menu__panel--hidden">
                                    ...
                                    <div class="mobile-menu__panel-body">
                                        <ul class="mobile-menu__links">
                                            <li data-mobile-menu-item>
                                                <a href="blog-classic-right-sidebar.html" class=""
                                                    data-mobile-menu-trigger>
                                                    Blog Classic
                                                    <svg width="7" height="11">
                                                        <path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                                                ...
                                                <div class="mobile-menu__links-panel" data-mobile-menu-panel>
                                                    <div class="mobile-menu__panel mobile-menu__panel--hidden">
                                                        ...
                                                        <div class="mobile-menu__panel-body">
                                                            <ul class="mobile-menu__links">
                                                                <li data-mobile-menu-item>
                                                                    <a href="blog-classic-left-sidebar.html" class=""
                                                                        data-mobile-menu-trigger>
                                                                        Left Sidebar
                                                                    </a>
                                                                </li>
                                            ...
                                            <li data-mobile-menu-item>
                                                <a href="blog-list-right-sidebar.html" class=""
                                                    data-mobile-menu-trigger>
                                                    Blog List
                                                    <svg width="7" height="11">
                                                        <path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                                                ...
                                                <div class="mobile-menu__links-panel" data-mobile-menu-panel>
                                                    <div class="mobile-menu__panel mobile-menu__panel--hidden">
                                                        ...
                                                        <div class="mobile-menu__panel-body">
                                                            <ul class="mobile-menu__links">
                                                                <li data-mobile-menu-item>
                                                                    <a href="blog-list-left-sidebar.html" class=""
                                                                        data-mobile-menu-trigger>
                                                                        Left Sidebar
                                                                    </a>
                                                                </li>
                                            ...
                                            <li data-mobile-menu-item>
                                                <a href="blog-grid-right-sidebar.html" class=""
                                                    data-mobile-menu-trigger>
                                                    Blog Grid
                                                    <svg width="7" height="11">
                                                        <path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
                                                ...
                                                <div class="mobile-menu__links-panel" data-mobile-menu-panel>
                                                    <div class="mobile-menu__panel mobile-menu__panel--hidden">
                                                        ...
                                                        <div class="mobile-menu__panel-body">
                                                            <ul class="mobile-menu__links">
                                                                <li data-mobile-menu-item>
                                                                    <a href="blog-grid-left-sidebar.html" class=""
                                                                        data-mobile-menu-trigger>
                                                                        Left Sidebar
                                                                    </a>
                                                                </li>
                                                ...
                                                <div class="mobile-menu__links-panel" data-mobile-menu-panel>
                                                    <div class="mobile-menu__panel mobile-menu__panel--hidden">
                                                        ...
                                                        <div class="mobile-menu__panel-body">
                                                            <ul class="mobile-menu__links">
                                                                <li data-mobile-menu-item>
                                                                    <a href="post-full-width.html" class=""
                                                                        data-mobile-menu-trigger>
                                                                        Full Width
                                                                    </a>
                                                                </li>
                                                                <li data-mobile-menu-item>
                                                                    <a href="post-left-sidebar.html" class=""
                                                                        data-mobile-menu-trigger>
                                                                        Left Sidebar
                                                                    </a>
                                                                </li>
                                                                <li data-mobile-menu-item>
                                                                    <a href="post-right-sidebar.html" class=""
                                                                        data-mobile-menu-trigger>
                                                                        Right Sidebar
                                                                    </a>
                                                                </li>
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                        ...
                        <li data-mobile-menu-item>
                            <a href="https://themeforest.net/item/redparts-auto-parts-html-template/24735474"
                                class="highlight" target="_blank" data-mobile-menu-trigger>
                                Buy Theme
                            </a>
                        </li>
                    </ul>
