...
{{-- // u will use the moneyphp in this project ?yes , ok then cloneing is usefuleLOL :D --}}
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2021 <a href="/">AmericanGroup</a>.</strong> All rights reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
